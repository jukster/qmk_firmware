...
[0] = LAYOUT_65_ansi_split_bs(
  ...
  KC_BSPC, KC_A,    KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,    KC_L,    CU_SCLN,    CU_QUOT,                KC_ENT,  KC_PGDN,    \
  KC_LSFT, KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_MINS, KC_RSFT,                KC_UP,   KC_DEL,     \
  KC_LCTL, KC_LALT, CU_LGUI,              KC_SPC,                    MO(1), KC_RALT, KC_RCTL, KC_LEFT,       KC_DOWN, KC_RGHT),
