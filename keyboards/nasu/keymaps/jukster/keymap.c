...
[0] = LAYOUT_alice_split_bs( /* Base */
    ...
    KC_PGDN, LT(1, KC_BSPC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
             KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, MO(1),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case CU_CH:
        if (record->event.pressed) {
            ...
            SEND_STRING(SS_DOWN(X_LCTL)SS_TAP(X_SPC)SS_UP(X_LCTL)SS_DELAY(50)";"SS_DOWN(X_LCTL)SS_TAP(X_SPC)SS_UP(X_LCTL));
        } else {
